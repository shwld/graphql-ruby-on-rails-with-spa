 ...
 * });
 */
export function useSayMutation(options: VueApolloComposable.UseMutationOptions<SayMutation, SayMutationVariables>) {
 ...
 * );
 */
export function useOnMessageAddedSubscription(options: VueApolloComposable.UseSubscriptionOptions<OnMessageAddedSubscription, OnMessageAddedSubscriptionVariables> | VueCompositionApi.Ref<VueApolloComposable.UseSubscriptionOptions<OnMessageAddedSubscription, OnMessageAddedSubscriptionVariables>> | ReactiveFunction<VueApolloComposable.UseSubscriptionOptions<OnMessageAddedSubscription, OnMessageAddedSubscriptionVariables>> = {}) {
