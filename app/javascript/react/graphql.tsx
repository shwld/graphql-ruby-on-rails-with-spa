...
`
export type SayMutationFn = Apollo.MutationFunction<
  SayMutation,
...
export function useSayMutation(
  baseOptions?: Apollo.MutationHookOptions<SayMutation, SayMutationVariables>
) {
  return Apollo.useMutation<SayMutation, SayMutationVariables>(
    SayDocument,
    baseOptions
  )
}
...
export type SayMutationOptions = Apollo.BaseMutationOptions<
  SayMutation,
  SayMutationVariables
>
...
export function refetchCurrentUserQuery(variables?: CurrentUserQueryVariables) {
  return { query: CurrentUserDocument, variables }
}
...
export function useOnMessageAddedSubscription(
  ...
  return Apollo.useSubscription<
    OnMessageAddedSubscription,
    OnMessageAddedSubscriptionVariables
  >(OnMessageAddedDocument, baseOptions)
}
export type OnMessageAddedSubscriptionHookResult = ReturnType<
  typeof useOnMessageAddedSubscription
>
export type OnMessageAddedSubscriptionResult = Apollo.SubscriptionResult<
  OnMessageAddedSubscription
>
